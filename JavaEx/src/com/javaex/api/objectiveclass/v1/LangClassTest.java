...
public class LangClassTest {
	...
	public static void main(String[] args) {
		...
		// 최상위 부모  -> object
		System.out.println(p.getClass());						// p 의 객체 정보
		System.out.println(p.getClass().getSimpleName());		// 클래스 정보  ->  문자열
		System.out.println(p.toString());						// 객체 정보를 문자열로 변환
		System.out.println(p);
		// toString() : 출력시 or 문자열과 연결될 때 자동으로 호출
		System.out.println(p.hashCode());						// 객체 식별을 위한 유일한 정수 값
