...
//		twoDimens();
	...
	private static void twoDimens() {
		int[][] twoDimens = new int [5][10]; 	// 5 행 10 열
		...
		System.out.println("배열 요소의 총 합 : " + total);
...
//		System.out.println(names);
		...
		scores = new int[4];	// 4 개의 공간을 가진 빈 배열
		// 공간에 접근하려면 인덱스를 사용
...
//		System.out.println(scores);
		...
		System.out.println("scores 와 scores2 는 같은 객체?" + (scores == scores2));
